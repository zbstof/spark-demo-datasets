...
import org.apache.spark.sql.{Column, Dataset, Encoders, SaveMode, SparkSession}
...
object Detector {
  def main(args: Array[String]): Unit = {
    ...
    val streamingContext: StreamingContext = StreamingContext.getOrCreate(checkpointDir, () => {
